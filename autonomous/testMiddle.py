...
class TestingPathFinder(AutonomousStateMachine):

    MODE_NAME = "Testing Pathfinder"
    DEFAULT = False
    ...
    def on_enable(self):
        ...
        if gameData[0] == 'R':
            points = [
                ...
                pf.Waypoint(7, -7.5, pf.d2r(0)),
                pf.Waypoint(10.5, -5.8, pf.d2r(90))
            ]
        else:
            points = [
                pf.Waypoint(0, 0, pf.d2r(0)),
                pf.Waypoint(7, 9.5, pf.d2r(0)),
                pf.Waypoint(10.5, 8, pf.d2r(90))
            ]
